 ...
 *
 * Authentication (dual):
 *   - X-Alex-Secret header (preferred for CI/VPS callers)
 *   - Basic Auth with WP Application Password (manage_options required)
 *
...
if (!$auth_ok) {
    ...
    if (stripos($authz, 'Basic ') === 0) {
        ...
        if ($decoded !== false && strpos($decoded, ':') !== false) {
            ...
            // Defer verification until after WP bootstrap
