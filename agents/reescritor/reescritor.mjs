...
Output ONLY a JSON object — no prose, no markdown fences:
{
  ...
  "visual_prompt": "${isReel ? 'JSON narrative B for Director v2 (validated by validateSpec). HARD CONSTRAINTS — failure = render error: {\"narrative\":\"B\", \"theme\":one of [\"T1\",\"T2\",\"T3\",\"T4\",\"T5\"] EXACTLY, \"template\":one of [\"hybrid\",\"pip\",\"voiceover\",\"talkinghead\",\"editorial\"], \"aspect\":\"9:16\", \"duration\":INTEGER 7-15 ONLY (e.g. 12, NOT 30), \"locale\":\"es\", \"hook\":{\"en\":string,\"es\":string}, \"points\":array of EXACTLY 3 items each with {\"captionEs\":string,\"captionEn\":string,\"heroQuery\":string for Pexels search,\"heroPrompt\":string for FLUX2}, \"cta\":{\"en\":string,\"es\":string}}' : 'TITLE: <titulo> | TEMA: one of T1/T2/T3/T4/T5 EXACTLY | <Formato> Pinnacle Audiencia: distressed Wisconsin homeowner [target segment]'}",
  "lesson": {
