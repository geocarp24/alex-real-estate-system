...
AIRTABLE_TRACY:      tbl6CJm4kYspOuTDB      ← tabla de log de rastreos
AIRTABLE_CONTACTS:   tblacvw0Ss770x8l5      ← tabla de contactos encontrados
```
...
```bash
curl -s "https://api.airtable.com/v0/appfQbDA750Oihy9J/tbl6CJm4kYspOuTDB?filterByFormula=LOWER({address})=LOWER('123 Main St')" \
...
```bash
curl -s -X POST "https://api.airtable.com/v0/appfQbDA750Oihy9J/tbl6CJm4kYspOuTDB" \
  -H "Authorization: Bearer patQXGBEGdmbhGRfi.81e226fee4638f95bba27a57003465dd930d9e977d8b4dc7ac372c1b60dd087b" \
...
curl -s -X POST "https://tracerfy.com/v1/api/trace/" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjozMjQyNTY2NDc4LCJpYXQiOjE3NzM3NjY0NzgsImp0aSI6IjFkNmMwZTc5YjRjZDRmZGY5YTUzNmQ4NTAzYjFiNTY2IiwidXNlcl9pZCI6NTc2MX0.P7H9nO6KFP-2UfSDl33RX4yxOislHV-v7V2vbPlJIWg" \
...
```bash
curl -s -X PATCH "https://api.airtable.com/v0/appfQbDA750Oihy9J/tbl6CJm4kYspOuTDB/{TRACY_RECORD_ID}" \
  -H "Authorization: Bearer patQXGBEGdmbhGRfi.81e226fee4638f95bba27a57003465dd930d9e977d8b4dc7ac372c1b60dd087b" \
  -H "Content-Type: application/json" \
  -d '{
    "fields": {
...
```bash
curl -s -X POST "https://api.airtable.com/v0/appfQbDA750Oihy9J/tblacvw0Ss770x8l5" \
  -H "Authorization: Bearer patQXGBEGdmbhGRfi.81e226fee4638f95bba27a57003465dd930d9e977d8b4dc7ac372c1b60dd087b" \
  -H "Content-Type: application/json" \
  -d '{
    "fields": {
