...
```
Authorization: Bearer patQXGBEGdmbhGRfi.81e226fee4638f95bba27a57003465dd930d9e977d8b4dc7ac372c1b60dd087b
...
### 4. NOTES & ACTIVITY — `tbleOBXJl7sDhwj5w`
...
# Ordenar y limitar
curl -s "https://api.airtable.com/v0/appfQbDA750Oihy9J/{TABLE_ID}?maxRecords=10&sort[0][field]=Dated%20Added&sort[0][direction]=desc" \
  -H "Authorization: Bearer patQXGBEGdmbhGRfi.81e226fee4638f95bba27a57003465dd930d9e977d8b4dc7ac372c1b60dd087b"
```
...
```bash
curl -s "https://api.airtable.com/v0/appfQbDA750Oihy9J/{TABLE_ID}?filterByFormula=SEARCH('texto_a_buscar',{NombreCampo})" \
  -H "Authorization: Bearer patQXGBEGdmbhGRfi.81e226fee4638f95bba27a57003465dd930d9e977d8b4dc7ac372c1b60dd087b"
```
