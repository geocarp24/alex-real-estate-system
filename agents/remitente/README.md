...
|---|---|---|
| `Email_Subscribers` | `tblEiB0fBeGxxq7if` | 1 row por email (status: Active/Unsubscribed/Bounced/Complained) |
| `Email_Templates` | `tbljcO5b5i2SZs3ze` | Reusable templates con {{placeholders}} |
| `Email_Campaigns` | `tblBJAtH3k1IVhqqc` | Broadcasts (Draft→Scheduled→Sending→Sent) |
| `Email_Events` | `tblTNKwwXZTBXymOD` | Per-recipient event log (sent/opened/clicked/bounced/...) |
