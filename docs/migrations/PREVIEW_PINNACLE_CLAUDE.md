...
- Esta regla está en `PINNACLE_MEMORIA.md` y `agents/oraculo_inputs/sm_lessons.md`
...
1. `PINNACLE_MEMORIA.md` (raíz) — memoria operacional principal
2. `agents/PINNACLE_AGENTS_MEMORIA.md` — memoria de sub-agentes
...
- Resumen de lo trabajado → `PINNACLE_MEMORIA.md` sección dated
- Espejo en `agents/PINNACLE_AGENTS_MEMORIA.md` + `telegram_bot/telegram_memory.md` para continuidad cross-channel
...
2. **Lee el archivo `PINNACLE_MEMORIA.md`** en el directorio del proyecto. Extrae y menciona brevemente cualquier nota relevante (zip codes analizados, flags de riesgo, lecciones aprendidas).
...
1. **Lee `PINNACLE_MEMORIA.md`** — verifica si hay notas previas sobre ese mercado o tipo de propiedad.
...
6. **Escribe en `PINNACLE_MEMORIA.md`** — registra los nuevos aprendizajes del deal.
...
### `PINNACLE_MEMORIA.md` — Memoria Operacional (compartida)
...
**Documento de referencia completo:** `agents/protocolo_seguro.md` — léelo al inicio de cada sesión junto con `PINNACLE_MEMORIA.md`.
...
- ALEX Telegram Bot y ALEX Claude Code comparten memoria: `PINNACLE_MEMORIA.md` + `telegram_memory.md`
